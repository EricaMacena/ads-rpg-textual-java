...
public class TerraExiladaPI {
    ...
    public static void conteudoBasico() {
        try {
            Desktop.getDesktop()
                    .browse(new URI("https://mega.nz/file/EH1CzSLD#KaThOiB5DsSRpmE2kBG9ZpY9l3q0hrV5fv5rYPN_J9A"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void conteudoIntermediario() {
        try {
            Desktop.getDesktop()
                    .browse(new URI("https://mega.nz/file/UaVmyCib#c5rqbHuyYOCnzFt3Z3f6MQkpcSCLBaivHB_vCSNsUck"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void conteudoAvançado() {
        try {
            Desktop.getDesktop()
                    .browse(new URI("https://mega.nz/file/RaEjGZqS#hIFI1AmnZV7fx3KPANAP4ItCsT3rWmWas9eM8CVul6c"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void operadoresRelacionais() {
        try {
            Desktop.getDesktop()
                    .browse(new URI("https://mega.nz/file/5PsF2BiJ#1pFVl29X-nlzUXda2ZSfaANXm1pfPvTnMh06LaqyzMI"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void validarAlternativa(String resposta) {
        ...
        while (!resposta.equalsIgnoreCase("A") && !resposta.equalsIgnoreCase("B") && !resposta.equalsIgnoreCase("C")
                && !resposta.equalsIgnoreCase("D")) {
            System.out.print("\nDigite (a, b, c ou d): ");
    ...
    public static void Desafio1() {
        ...
        while (tentativas < 3) {
            ...
            if (alternativas[escolha]
                    .contains("Repetir uma sequência de comandos por um número determinado de vezes")) {
    ...
    public static void Desafio2() {
        ...
        // Alternativas
        String[] alternativas = { "for(inicialização; atualização; incrementar ou decrementar)",
        ...
        while (tentativas < 3) {
            ...
            if (alternativas[escolha]
                    .contains("for(inicialização; condição de continuação; incrementar ou decrementar)")) {
                System.out.println("Parabéns, você acertou!");
                break;
            } else {
                erros++;
    ...
    public static void Desafio3() {
        ...
        String[] alternativas = { "Determinar o valor inicial da variável de controle do loop",
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "Opção 2: Se manter calmo e confiante, dizendo que está pronto para invadir o sistema de segurança.");
        System.out.println("\nDIGITE 1 PARA (OPÇÃO 1) OU 2 PARA (OPÇÃO 2):");
